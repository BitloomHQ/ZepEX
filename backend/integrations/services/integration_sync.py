    ...
    *,
    ...
    Flow:
        ...
        Refresh access token
            ↓
        Save refreshed tokens encrypted
            ↓
    ...
    create_integration_audit_log(
        ...
        action_by=None,
        message=(
            "BambooHR synchronization started."
        ),
        metadata={
            "trigger": trigger,
            "sync_log_id": str(
    ...
    try:
        ...
        # ======================================================
        # 6. CREATE BAMBOOHR OAUTH CLIENT
        # ======================================================
