...
def fetch_emails_task():
    """
    Fetch unread reimbursement emails from the platform IMAP inbox.
    Prefer EMAIL_IMAP_POLL_ENABLED on free hosts without Celery beat.
    """
    return run_email_fetch_once()
